            ...
            <div className='mb-12 space-y-4 sm:mb-16 lg:mb-24'>
              ...
              <MotionPreset fade slide={{ direction: 'down', offset: 50 }} delay={0.4} transition={{ duration: 0.7 }}>
                <p className='text-muted-foreground text-base leading-relaxed'>
                  La fiscalité immobilière peut sembler complexe. Notre simulateur gratuit et notre expertise de plus de 20 ans vous permettent de comprendre rapidement votre potentiel d&apos;économies avec la Loi Jeanbrun.
                </p>
              </MotionPreset>
            </div>
              ...
              <Card>
                <CardContent className='space-y-6'>
                  <div className='space-y-2.5'>
                    <h3 className='text-xl font-medium md:text-2xl'>Besoin d&apos;un accompagnement ?</h3>
                    <p className='text-muted-foreground leading-relaxed'>
                      Hervé Voirin et son équipe sont à votre disposition pour répondre à toutes vos questions et vous accompagner dans votre projet d&apos;investissement. Simulation gratuite et sans engagement.
                    </p>
                  </div>
