...
export default function TestimonialsGoogle({ testimonials }: TestimonialsProps) {
  ...
  return (
    <section className='bg-background pt-0 pb-2 sm:py-8 lg:py-12'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-4 text-center'>
          ...
          <p className='text-muted-foreground mx-auto mt-3 max-w-2xl text-base sm:text-lg'>
            Plus de 200 investisseurs nous ont fait confiance pour optimiser leur fiscalité. Découvrez leurs retours d&apos;expérience.
          </p>
        </div>
                  ...
                  <Card className='h-full shadow-md hover:shadow-lg transition-shadow'>
                    <CardContent className='p-6 space-y-4'>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        <BadgeCheck className='fill-blue-500 text-white' style={{ width: 18, height: 18 }} />
                      </div>
