      ...
      <CardContent className="relative">
          ...
          <Table>
            <TableHeader className="sticky top-0 z-20 bg-muted/50">
              <TableRow className="hover:bg-transparent">
                <TableHead className="text-center font-semibold">Annee</TableHead>
                <TableHead className="text-right font-semibold">Loyers</TableHead>
                <TableHead className="text-right font-semibold">Charges</TableHead>
                <TableHead className="text-right font-semibold">Interets</TableHead>
                <TableHead className="text-right font-semibold">Amort.</TableHead>
                <TableHead className="text-right font-semibold">Reduction IR</TableHead>
                <TableHead className="text-right font-semibold">Cash-flow</TableHead>
                <TableHead className="text-right font-semibold">Patrimoine</TableHead>
              </TableRow>
            </TableHeader>
                ...
                return (
                  ...
                  >
                    <TableCell className="text-center font-medium">
                      {row.annee}
                      {isCurrentYear && (
                        <span className="ml-2 text-xs text-accent-foreground">(actuelle)</span>
                      )}
                    </TableCell>
        ...
        <div className="mt-4 flex flex-wrap gap-4 text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
            <div className="h-3 w-3 rounded-sm bg-accent/10 border border-accent/20" />
